...
public class AuctionService {
    ...
    @Transactional(readOnly = true)
    public PageResponse<RecommendAuctionResponse> getUserPreferredCategoryAuctions(User user,
        Pageable pageable) {
        List<ProductCategory> productCategories = preferredProductCategoryRepository.findByUser(
                user)
            .stream()
