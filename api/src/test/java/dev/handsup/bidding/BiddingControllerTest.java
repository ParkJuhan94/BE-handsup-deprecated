...
import dev.handsup.event.consumer.BiddingEventListener;
import dev.handsup.event.consumer.BiddingRegisterEventHandler;
...
class BiddingControllerTest extends ApiTestKafkaSupport {
    ...
    void setUp() {
        ...
        accessTokenOfSeller = accessToken;
        accessTokenOfBidder = jwtProvider.createAccessToken(bidder.getId());
    ...
    void registerBiddingTest() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(
            MockMvcRequestBuilders
                ...
                .header(AUTHORIZATION, "Bearer " + accessTokenOfBidder)
    ...
    void completeTrading() throws Exception {
        ...
        mockMvc.perform(patch("/api/auctions/bids/{biddingId}/complete", bidding.getId())
                .contentType(APPLICATION_JSON)
                .header(AUTHORIZATION, "Bearer " + accessTokenOfSeller))
